...
// Tue Jul 11 09:35:11 2017 by ROOT version 6.04/14
// from TTree LHEF/Analysis tree
// found on file: unweighted_events.root
//////////////////////////////////////////////////////////

#ifndef LHEF_backup_h
#define LHEF_backup_h
...
#ifdef LHEF_backup_cxx
LHEF_backup::LHEF_backup(TTree *tree) : fChain(0) 
{
...
LHEF_backup::~LHEF_backup()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t LHEF_backup::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t LHEF_backup::LoadTree(Long64_t entry)
{
...
void LHEF_backup::Init(TTree *tree)
{
...
void LHEF_backup::Show(Long64_t entry)
{
...
Int_t LHEF_backup::Cut(Long64_t entry)
{
